...
The Shiny [@R-shiny] application and stand-alone implementation of the HWP model are available on [GitHub](https://github.com/).  You will need to have Git installed on your computer, connect Git to RStudio, and finally tell RStudio where the GitHub files are to download (pull).  Once you have these files you will have the most up-to-date version of the deployed code.
